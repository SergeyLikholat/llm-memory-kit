...
STAMP="$DIR/.entity.lastrun"; LOCK="$DIR/.entity.lock"; LOG="$DIR/entity.log"; ATT="$DIR/.entity.attempts"
...
log "построение entity-хабов… (попытка $ac/3)"; node "$DIR/entity-builder.js" >> "$LOG" 2>&1; rc=$?
